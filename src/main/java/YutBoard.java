...
public class YutBoard {
    ...
    public void showBoard(Gamer gamer1,Gamer gamer2){
        ...
        System.out.println("\t" + horse1[25] + horse2[25] +coordinates[25]+ "\t" + "\t" + "\t" + "\t" + horse1[20] + horse2[20] + coordinates[20] + "\t");
        ...
        System.out.println(horse1[15] + horse2[15] +coordinates[15] + "\t" + horse1[16] + horse2[16] +coordinates[16]+ "\t" + horse1[17] +horse2[17] +coordinates[17] + "\t" + "\t" + horse1[18] + horse2[18] +coordinates[18] + "\t" + horse1[19] + horse2[19] +coordinates[19] + "\t" + horse1[29] +horse2[29] +coordinates[29]);
    }
